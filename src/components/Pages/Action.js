...
function Action() {
  ...
  useEffect(() => {
    const fetchActionMovies = async () => {
      try {
        ...
        const url = `https://api.themoviedb.org/3/discover/movie?with_genres=28&page=${page}`; // Genre ID 28 corresponds to Action
        ...
        setActionMovies(response.data.results); // Set the action movies
      } catch (error) {
  ...
  // Skeleton loader for action movies
  ...
  return (
    <div className="bg-gray-800 py-8 ">
      <div className="mx-3 md:mx-10 lg:mx-18 mt-16">
        <h2 className="text-2xl font-semibold text-white mb-6">Action Movies</h2>
