...
function Comedy() {
  ...
  useEffect(() => {
    const fetchComedyMovies = async () => {
      try {
        ...
        const genreId = "35"; // Genre ID for Comedy movies
        ...
        setComedyMovies(response.data.results); // Set the comedy movies
      } catch (error) {
  ...
  return (
    <div className="bg-gray-800 py-8">
      ...
      <h2 className="text-2xl font-semibold text-white mb-6">Comedy Movies</h2>
