...
function Horror() {
  ...
  useEffect(() => {
    const fetchHorrorMovies = async () => {
      try {
        ...
        const genreId = "27"; // Genre ID for Horror movies
        ...
        setHorrorMovies(response.data.results); // Set the horror movies
      } catch (error) {
  ...
  return (
    <div className="bg-gray-800 py-8">
      ...
      <h2 className="text-2xl font-semibold text-white mb-6">Horror Movies</h2>
